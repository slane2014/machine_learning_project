...
numbers of variables that contain NA values. I removed those variables since they clearly don't add predictability.
...
We can learn several things from this output. The graph above shows the relative 
importance of each variable in our data set. We can also see that the out-of-bag 
estimate of error rate is very low. 
